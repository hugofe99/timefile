...
def _plot_and_save(f_name: str, y: list, y_name: str, t: list, t_name: str = "Time (s)"):
    ...
    plt.savefig(f"{config.PLOT_DIR}/{f_name} {y_name} vs {t_name} @{datetime.now().strftime(config.LOGGING_DATETIME)}.png")
    plt.close()
